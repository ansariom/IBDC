...
#		echo $score_file
                ...
                software/flip_row_rm_header.pl $tmp_file > $outbase_scoreext
                ...
                software/flip_row_rm_header.pl $tmp_file > $outbase_locext
        ...
        software/sum_dists.R $tmpout_dir/$pwm_name.$strand.all.txt $outfile
